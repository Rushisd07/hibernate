...
public class Book {
	...
	private Map<String,Integer> author;
	...
	public Book(Integer bk_id, String bk_name, String publisher, Map<String, Integer> author) {
		super();
		this.bk_id = bk_id;
	...
	public void setAuthor(Map<String, Integer> author) {
		this.author = author;
	}
